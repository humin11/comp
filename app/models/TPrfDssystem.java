...
public class TPrfDssystem extends PrfModel{
	 ...
	 * For HDS Remote Copy
	 */
	public Long RC_ALL_RIO;
	public Long RC_ALL_WRITE;
	public Long RC_RIO_ERROR;
	public Long RC_INITIAL_COPY_RIO;
	//unit: KB/s
	public Long RC_INITIAL_COPY_KB;
	//unit:ms
	public Long RC_INITIAL_COPY_RESPONSE;
	public Long RC_UPDATE_COPY_RIO;
	//unit: KB/s
	public Long RC_UPDATE_COPY_KB;
	//unit:ms
	public Long RC_UPDATE_COPY_RESPONSE;
	//unit %
	public Long RC_PAIR_SYNCHRONIZED;
	
	public Long RC_OUT_OF_TRACKS;
	
	
	/*
	 * For HDS UR
	 */
	public Long UR_WRITE_RECORD;
	//unit: KB/s
	public Long UR_WRITE_KB;
	public Long UR_INITIAL_COPY_RIO;
	//unit: KB/s
	public Long UR_INITIAL_COPY_KB;
	
	public Long UR_MJNL_RIO;
	public Long UR_MJNL_ASYNCHRONOUS_JOURNAL;
	//unit: KB/s
	public Long UR_MJNL_ASYNCHRONOUS_COPY_TRANSFER;
	//unit: ms
	public Long UR_MJNL_ASYNCHRONOUS_COPY_RESPONSE;
	public Long UR_RJNL_ASYNCHRONOUS_RIO;
	public Long UR_RJNL_ASYNCHRONOUS_JOURNAL;
	//unit: KB/s
	public Long UR_RJNL_ASYNCHRONOUS_COPY_TRANSFER;
	//unit: ms
	public Long UR_RJNL_ASYNCHRONOUS_COPY_RESPONSE;
