 ...
 * Class Name：TRrfDsvol
 * Class Desc：
 * Author：tigaly
 * Create Date：2012-3-1 上午11:09:52
 * Last Modified By：tigaly
 * Last Modified：2012-3-1 上午11:09:52
 * Remarks：
 * @version 
 * 
 */
...
@Entity
@Table(name="T_PRF_DSVOL",uniqueConstraints={@UniqueConstraint(columnNames={"TIME_ID","ELEMENT_ID"})})
public class TPrfDsvol extends PrfModel{
	...
	public Long READ_NRM_KB;
	public Long WRITE_NRM_KB;
	public Long READ_SEQ_KB;
	public Long WRITE_SEQ_KB;
	...
	public Long READ_KB_HITS;
	public Long READ_KB_MISS;

	public Long READ_IO;
	public Long WRITE_IO;
	public Long TOTAL_IO;
	public Long READ_HITS;
	public Long READ_MISS;
