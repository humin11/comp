 ...
 */
@Entity
@Table(name="T_CHANGED_STORAGE_FILE_SYSTEM",uniqueConstraints={@UniqueConstraint(columnNames={"ELEMENT_ID","CHANGED_TIME"})})
public class TChangedStorageFileSystem extends ChangedModel {
