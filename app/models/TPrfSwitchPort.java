 ...
 * Class Name：TPrfSwitchPort
 * Class Desc：
 * Author：tigaly
 * Create Date：2012-3-2 上午1:03:50
 * Last Modified By：tigaly
 * Last Modified：2012-3-2 上午1:03:50
 * Remarks：
 * @version 
 * 
 */
@Entity
@Table(name="T_PRF_SWITCH_PORT",uniqueConstraints={@UniqueConstraint(columnNames={"TIME_ID","ELEMENT_ID"})})
public class TPrfSwitchPort extends PrfModel{
	public Long SEND_KB;
	public Long RECV_KB;
