...
public class CIM_Qualifiers
{
    ...
    public String diskType(int diskType)
    {
        String diskTypeConversion = null;
        switch (diskType) {
            case 0:
                diskTypeConversion = "FC"; break;
            case 1:
                diskTypeConversion = "SOP"; break;
            case 2:
                diskTypeConversion = "NL_SAS"; break;
            case 3:
                diskTypeConversion = "SCSI"; break;
            case 4:
                diskTypeConversion = "HDD"; break;
            case 5:
                diskTypeConversion = "SSD"; break;
            case 6:
                diskTypeConversion = "HYBRID"; break;
            default:
                diskTypeConversion = "Unknown";
        }
        return diskTypeConversion;
    }

    public String softwareClassifications(int classification)
    {
        String classificationConversion = null;
        switch (classification) { case 0:
    ...
    {
        String classificationConversion = null;
        switch (mediaTypesSupported) { case 0:
            classificationConversion = "Unknown"; break;
            case 1:
                classificationConversion = "Other"; break;
            case 2:
