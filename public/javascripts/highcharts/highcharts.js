...
Axis.prototype = {
	...
	init: function (chart, userOptions) {
		...
		axis.labelFormatter = eval(options.labels.formatter) || axis.defaultLabelFormatter; // can be overwritten by dynamic format
...
Tooltip.prototype = {
	...
	refresh: function (point, mouseEvent) {
		var tooltip = this,
			...
			text,
			pointConfig = [],
			formatter = eval(options.formatter) || tooltip.defaultFormatter,
